                            ...
                            FSUPERPOINT::TDescriptor &mean)
{
    ...
    {
        vector<int> sum(FSUPERPOINT::L * 8, 0);
        ...
        mean = cv::Mat::zeros(1, FSUPERPOINT::L, CV_8U);
...
int FSUPERPOINT::distance(const FSUPERPOINT::TDescriptor &a,
...
{
    a.create(1, FSUPERPOINT::L, CV_8U);
                    ...
                    cv::Mat &mat)
{
    ...
    mat.create(N, FSUPERPOINT::L*8, CV_32F);
