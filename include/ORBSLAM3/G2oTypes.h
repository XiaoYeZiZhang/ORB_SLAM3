...
#include <include/ORBSLAM3/Frame.h>
...
public:
    ...
    Eigen::Vector2d
    Project(const Eigen::Vector3d &Xw, int cam_idx = 0) const; // Mono
    Eigen::Vector3d
    ProjectStereo(const Eigen::Vector3d &Xw, int cam_idx = 0) const; // Stereo
...
public:
    ...
    VertexPose4DoF(
        Eigen::Matrix3d &_Rwc, Eigen::Vector3d &_twc, KeyFrame *pKF) {
...
class EdgeMono : public g2o::BaseBinaryEdge<
                     2, Eigen::Vector2d, g2o::VertexSBAPointXYZ, VertexPose> {
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
...
class EdgeStereo : public g2o::BaseBinaryEdge<
                       3, Eigen::Vector3d, g2o::VertexSBAPointXYZ, VertexPose> {
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
...
class EdgeGyroRW : public g2o::BaseBinaryEdge<
                       3, Eigen::Vector3d, VertexGyroBias, VertexGyroBias> {
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
...
class EdgeAccRW : public g2o::BaseBinaryEdge<
                      3, Eigen::Vector3d, VertexAccBias, VertexAccBias> {
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
...
public:
    ...
    ConstraintPoseImu(
        const Eigen::Matrix3d &Rwb_, const Eigen::Vector3d &twb_,
    ...
    ConstraintPoseImu(
        const cv::Mat &Rwb_, const cv::Mat &twb_, const cv::Mat &vwb_,
