...
Eigen::Vector2d
ImuCamPose::Project(const Eigen::Vector3d &Xw, int cam_idx) const {
...
Eigen::Vector3d
ImuCamPose::ProjectStereo(const Eigen::Vector3d &Xw, int cam_idx) const {
...
InvDepthPoint::InvDepthPoint(
    double _rho, double _u, double _v, KeyFrame *pHostKF)
...
void EdgeInertial::computeError() {
    ...
    const IMU::Bias b1(
        VA1->estimate()[0], VA1->estimate()[1], VA1->estimate()[2],
...
void EdgeInertialGS::computeError() {
    ...
    const IMU::Bias b(
        VA->estimate()[0], VA->estimate()[1], VA->estimate()[2],
