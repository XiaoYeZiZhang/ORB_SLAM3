...
void Sim3Solver::SetRansacParameters(
    double probability, int minInliers, int maxIterations) {
...
void Sim3Solver::ComputeSim3(cv::Mat &P1, cv::Mat &P2) {
    ...
    N =
        (cv::Mat_<float>(4, 4) << N11, N12, N13, N14, N12, N22, N23, N24, N13,
...
void Sim3Solver::Project(
    const vector<cv::Mat> &vP3Dw, vector<cv::Mat> &vP2D, cv::Mat Tcw,
...
void Sim3Solver::FromCameraToImage(
    const vector<cv::Mat> &vP3Dc, vector<cv::Mat> &vP2D,
    GeometricCamera *pCamera) {
    vP2D.clear();
